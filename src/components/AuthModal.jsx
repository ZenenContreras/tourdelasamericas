      ...
      >
        ...
        <div className="px-6 py-8">
          <div className="flex justify-center">
            <img src="/LogoAunClic.svg" alt="Á un Clic" className="h-20 w-auto" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center text-sm my-4">
              ...
              <span className="px-3 text-gray-500">{t('auth.login.orContinueWith')}</span>
              <div className="h-px bg-gray-300 flex-1"></div>
            </div>
            ...
            <div>
              <button
                ...
                className="w-full flex justify-center items-center py-3 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-200"
              >
        ...
        <div className="px-6 py-4 bg-gray-50 text-sm text-center border-t border-gray-200">
          {mode === 'login' ? (
            <p>
