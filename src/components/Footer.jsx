...
const Footer = () => {
  ...
  const links = {
    quickLinks: [
      ...
      { name: t('nav.foods'), href: '/foods' },
      { name: t('nav.boutique'), href: '/boutique' },
      { name: t('nav.regions'), href: '/regions' }
    ],
    categories: [
      { name: t('regions.northAmerica.title'), href: '/regions' },
      { name: t('regions.centralAmerica.title'), href: '/regions' },
      { name: t('regions.southAmerica.title'), href: '/regions' }
    ]
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <motion.div {...fadeIn}>
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-bold">Tour de las Americas</h3>
            </div>
        ...
        >
          <div className="flex flex-col sm:flex-row justify-between items-center">
            <p className="text-gray-500 text-xs md:text-sm">&copy; {currentYear} Tour de las Americas. {t('footer.rights')}</p>
