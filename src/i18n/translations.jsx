export const translations = {
  en: {
    ...
    regions: {
      northAmerica: {
        title: 'North America',
        description: 'Discover exclusive products from the United States, Canada, and Mexico'
      },
      centralAmerica: {
        title: 'Central America',
        description: 'Explore the cultural richness of Guatemala, Costa Rica, and more'
      },
      southAmerica: {
        title: 'South America',
        description: 'Discover the treasures of Brazil, Argentina, Peru, and more countries'
      }
    },
    footer: {
      about: 'Connecting the Americas through authentic products and unique experiences.',
    ...
    products: {
      ...
      lowStock: "Only a few units left of {{product}}!",
    ...
    food: {
      ...
      lowStock: "Only a few units of {{food}} left!",
      outOfStock: "Out of stock",
      addToCart: "Add to cart",
    ...
    boutique: {
      ...
      lowStock: "Only a few units of {{item}} left!",
      addToCart: "Add to cart",
  ...
  es: {
    ...
    regions: {
      northAmerica: {
        title: 'Norteamérica',
        description: 'Descubre productos exclusivos de Estados Unidos, Canadá y México'
      },
      centralAmerica: {
        title: 'Centroamérica',
        description: 'Explora la riqueza cultural de Guatemala, Costa Rica y más'
      },
      southAmerica: {
        title: 'Sudamérica',
        description: 'Conoce los tesoros de Brasil, Argentina, Perú y más países'
      }
    },
    footer: {
      about: 'Conectando las Américas a través de productos auténticos y experiencias únicas.',
    ...
    products: {
      ...
      lowStock: "¡Quedan pocas unidades de {{product}}!",
    ...
    boutique: {
      ...
      lowStock: "¡Quedan pocas unidades de {{item}}!",
      addToCart: "Agregar al carrito",
  ...
  fr: {
    ...
    regions: {
      northAmerica: {
        ...
        description: 'Découvrez des produits exclusifs des États-Unis, du Canada et du Mexique'
      },
      centralAmerica: {
        title: 'Amérique Centrale',
        description: 'Explorez la richesse culturelle du Guatemala, du Costa Rica et plus'
      },
      southAmerica: {
        title: 'Amérique du Sud',
        description: 'Découvrez les trésors du Brésil, de l\'Argentine, du Pérou et plus'
      }
    },
    footer: {
      about: 'Connecter les Amériques à travers des produits authentiques et des expériences uniques.',
    ...
    products: {
      ...
      lowStock: "Il ne reste que quelques unités de {{product}} !",
    ...
    food: {
      ...
      lowStock: "Il ne reste que quelques unités !",
      outOfStock: "En rupture de stock",
      addToCart: "Ajouter au panier",
    ...
    boutique: {
      ...
      lowStock: "Il ne reste que quelques unités de {{item}} !",
      addToCart: "Ajouter au panier",
    ...
    cart: {
      ...
      cleared: "Panier vidé",
      loginRequired: "Vous devez être connecté pour ajouter des produits au panier",
      errorLoading: "Erreur lors du chargement du panier",
      errorAdding: "Erreur lors de l'ajout au panier",
      errorUpdating: "Erreur lors de la mise à jour du panier",
      errorRemoving: "Erreur lors de la suppression du panier",
      errorClearing: "Erreur lors du vidage du panier",
