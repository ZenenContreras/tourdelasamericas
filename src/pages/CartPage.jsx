                ...
                <div className="bg-white rounded-lg shadow-sm p-6">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between text-gray-500">
                      <span className="text-base">{t('cart.shipping.title')}</span>
                      <span className="text-base">{t('cart.shipping.calculating')}</span>
                    </div>

                    <div className="border-t border-gray-200 pt-4">
                      <div className="flex items-center justify-between mb-6">
                        <span className="text-lg font-medium text-gray-900">{t('cart.summary.total')}</span>
                ...
                <div className="bg-white rounded-lg shadow-sm p-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="text-sm font-medium text-gray-900">{t('cart.shipping.free')}</h3>
                        <p className="mt-1 text-sm text-gray-500">{t('cart.shipping.details')}</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <Truck className="h-6 w-6 text-indigo-600 flex-shrink-0" />
                      <div>
                        <h3 className="text-sm font-medium text-gray-900">{t('cart.shipping.express')}</h3>
                        <p className="mt-1 text-sm text-gray-500">{t('cart.shipping.expressDetails')}</p>
                      </div>
                    </div>
                  </div>
                </div>
