    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="mt-2 text-lg font-medium text-gray-900">Inicia sesión para ver tus favoritos</h2>
          <p className="mt-1 text-sm text-gray-500">Necesitas iniciar sesión para acceder a tu lista de favoritos.</p>
        </div>
      </div>
    );
  }
